<section id="cart_items">
		<div class="container">
			<div class="breadcrumbs">
				<ol class="breadcrumb">
				  <li><a href="<?php echo base_url().'index.php/Customer/cekout' ?>">Status </a></li>
			...
			<div class="table-responsive cart_info">
				...
				<table class="table table-condensed">
					...
					<tr>
						<td colspan="3" class="cart_description" align="center"> <i class="fa fa-warning"> <h4><h3> Status Belanja Anda </h3> <br/> </h3><?php echo $k->status_pembayaran;  ?></h3></i></td>
					</tr>
					</tbody>
				</table>
				<button type="submit" class="btn btn-default cart"> <i class="fa fa-print"></i> Cetak Kwitansi </button>
			</form>
			</div>
		</div>
	</section> <!--/#cart_items-->