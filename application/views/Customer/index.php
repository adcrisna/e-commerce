                ...
                <div class="col-sm-3">
                    <div class="left-sidebar">
                        ...
                        <div class="shipping text-center"><!--shipping-->
                            <img src="<?php echo base_url().'assets/Frontend/images/home/shipping.jpg'?>" alt="" />
                        </div><!--/shipping-->
                            ...
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                        <div class="productinfo text-center">
                                            ...
                                            <a href="<?php echo base_url().'index.php/Customer/belanja/'.$p->id_produk.'' ?>" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</a>
                                        </div>
                        ...
                        <div class="col-sm-12">
                            <ul class="nav nav-tabs">
                                <?php 
                                    foreach ($kategori as $k) {
                                ?>  
                                <li><a href="#<?php echo $k->id_kategori; ?>" data-toggle="tab"><?php echo $k->nama_kategori; ?></a></li>
